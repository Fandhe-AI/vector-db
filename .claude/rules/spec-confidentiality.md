...
- **方式評価・受け入れ基準未達の原因分析**（方式 × fixture の実測比較・未達原因の
  構造分析・fixture 設計判断・Issue 差し戻し経緯・オーナー承認済み spec 改訂の事実と
  理由の要約）。オーナー判断（2026-08-31・AGENTS.md 同項・spec 側記録は
  `docs/spec/04-behavior/search.md` SEARCH-7 の公開境界注記）により公開可
