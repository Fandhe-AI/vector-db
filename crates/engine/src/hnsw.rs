...
impl HnswIndex {
    ...
    pub fn build(
        ...
        Self::build_impl(params, ResidentPrecision::F32, dim, vectors, seed)
    }
    ...
    fn build_impl(
        ...
        if n == 0 {
            return Self::freeze_from(builder, dim, owned_vectors, precision);
        }
        ...
        Self::freeze_from(builder, dim, owned_vectors, precision)
    }
